...
160 IF M=12AND N=1AND A 170 IF M=12AND N=0AND K<108AND X=0WAIT 0:GCURSOR K:GPRINT "00":K=K+1:GCURSOR K:GPRINT C$(0);:GOTO 130
...
690 WAIT 30:BEEP 2,150,30:GCURSOR SW-3:GPRINT S$:BEEP 5,5,5:WAIT 50:GCUROSR SW-9:GPRINT E$(0)
...
935 MX=127-POINT 140:GCUROS 140:WAIT 80:GPRINT ABS MX:CLS
