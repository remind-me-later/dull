...
8 "(4)/(6): Tourner G/D"
20 "Z"CLEAR 
90 D=0,V=0,A=0,K=113,Q=0,II=150,VM=200,BT=100,CH=100,MO=100,MU=100,ES=100
95 AR=20000,AM=100,FE=4,N=9:RANDOM 
...
312 WAIT 70:IF BT<10PRINT "BOITE FICHUE":D=0,VM=0,AM=0: GOTO 195
318 IF CH=0PRINT "CHASSIS FICHU":VM=0
319 IF MO<0LET MO=0
320 X=0,T=0,F=0,V=V+4:IF V>VMLET V=VM
322 IF V=VMLET MO=MO-5:VM=VM-1
...
366 IF CH=0PRINT "CHASSIS FICHU":VM=0,AM=0,D=0
367 ES=ES-0.5:IF ES<0LET ES=0,V=0,A=0,D=0
368 IF MO<0LET MO=0:PRINT "MOTEUR GRILLE":D=0,AM=0,VM=0
...
990 CLS :BEEP 1:IG=IG+1,X=0,L=0,R=0,M=0:IF IG>FE THEN 1800
1000 X=0,T=0,Z=0: GOTO 195
1100 WAIT 30:PRINT "CRAC!!":BEEP 2,50:BT=BT-10,VM=VM-20:IF VM<50PRINT "BOITE FICHUE"
1110  GOTO 195
...
2515 SS=ES/25:IF ES>100LET SS=4
2520 CLS :PRINT "ESSENCE:":GCURSOR 100:PRINT ES;"l":GCURSOR 135:GPRINT J$(INT SS):FOR I=1 TO 100:NEXT I
...
3330 IF LEFT$ (R$,1)="O"LET PX=10000: GOSUB 4000:CLS :IF RE=1LET MO=MO+100,VM=200
3400  GOTO 195
