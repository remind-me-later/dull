...
40		NEXT I: GCURSOR 154:GPRINT "141C":LET TIME=0,H=3,G=8
50		FOR P=2 TO 154:GCURSOR P-2
60		LET Z$ = INKEY$ :IF Z$ = "" THEN GOTO 85
70		LET H=H-SGN (ASC(Z$)-10.5)
80		LET G=INT(2^H+0.5)
85		LET S=R: LET R=Q: LET Q=POINT(P)
90		GPRINT S;G OR R;G OR Q
100		IF (Q AND G) > 0 THEN GOSUB "CRASH"
110		BEEP 1,0,1: NEXT P: IF H <> 3 THEN GOTO 50
120		CURSOR 0:PRINT "TIME :";TIME *100;" mn ":FOR I = 1 TO 5: BEEP 1,105,80 : BEEP 1,82,80: BEEP 1,68,80: NEXT I
130		END
200		"CRASH" FOR I=0 TO 30: POKE# 64000,RND(256)-1:NEXT I
210		CLEAR : LET P=2,G=8,H=3: RETURN
