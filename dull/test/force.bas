   ...
   22 FOR I=45TO 48:GOSUB "1":O$(I)=O$+"0"+STR$ (1+RND 2)+"0":NEXT I:O$(49)="111159"
  ...
  300 G=VAL RIGHT$ (O$(I),1):CLS :GOSUB "K":U=18:V=0:W=-1:GOSUB "S"
 ...
 1690 WAIT 180:PRINT "Exploratory orbit":M$="2":GOSUB "5"
 ...
 8010 GOSUB "2":CLS :ON AGOTO 8100,5,1850,8200,8400,8300,0,500
