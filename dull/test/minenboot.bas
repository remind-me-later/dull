...
160 IF M=12AND N=1AND A < Y GOSUB 272: WAIT 0: GCURSOR ABS A: GPRINT "00";:A=A+1:GCURSOR A:GPRINT B$(0);:GOTO 280
...
360 IF K < U+5 WAIT 0: GCURSOR U: XC=0:GPRINT "0000000000";: GCURSOR K: GPRINT C$(0);:GCURSOR A: GPRINT B$(0);:U=0
...
720 HW=0
740 IF ABS (K+10-D)=HW OR ABS (K+10-E)=HW OR ABS (K+10-F)=HW OR ABS (K+10-G)=HW RETURN
750 IF ABS (K+10-H)=HW OR ABS (K+10-I)=HW OR ABS (K+10-J)=HW RETURN
...
1000 CLS :INPUT "noch ein Spiel ? (J/N) ";U$:IF U$="J"THEN 10 1010 END
