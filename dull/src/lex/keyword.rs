...
impl Keyword {
    pub const LONGEST_SUFFIX_FIRST: [&'static str; 120] = [
        ...
        "RETURN", "RIGHT$", "ROTATE", "SETCOM", "SETDEV", "SPACE$", "STATUS", "UNLOCK", "AREAD",
        "BREAK", "CHAIN", "CLEAR", "CLOAD", "CSAVE", "CSIZE", "ERROR", "GOSUB", "GRAPH", "INPUT",
        "LEFT$", "LLIST", "MERGE", "PAUSE", "PEEK#", "POINT", "POKE#", "PRINT", "RLINE", "SORGN",
        "TROFF", "USING", "ARUN", "BEEP", "CALL", "CHR$", "COM$", "CONT", "COPY", "DATA", "DEVS",
        "FEED", "GOTO", "GRAD", "LINE", "LIST", "LOCK", "MID$", "NEXT", "PEEK", "POKE", "READ",
        "STEP", "STOP", "STR$", "TEST", "TEXT", "THEN", "TIME", "TRON", "WAIT", "ZONE", "ABS",
        "ACS", "AND", "ASC", "ASN", "ATN", "CLS", "COS", "DEC", "DIM", "DMS", "DTE", "END", "ERL",
        "ERR", "EXP", "FOR", "INT", "LEN", "LET", "LOG", "MEM", "NEW", "NOT", "OFF", "OPN", "REM",
        "RMT", "RND", "RUN", "SGN", "SIN", "SQR", "TAB", "TAN", "VAL", "IF", "LN", "ON", "OR",
        "PI", "TO",
    ];
