...
impl Keyword {
    ...
    pub const fn internal_code(&self) -> u16 {
        match self {
            ...
            Keyword::Line => 0xF0B7,
            Keyword::List => 0xF090,
            Keyword::Llist => 0xF0B8,
            Keyword::Ln => 0xF176,
            Keyword::Lock => 0xF1B5,
            Keyword::Log => 0xF177,
            Keyword::Lprint => 0xF0B9,
            Keyword::Mem => 0xF158,
            Keyword::Merge => 0xF08F,
            ...
            Keyword::Peek => 0xF16F,
            Keyword::PeekHashTag => 0xF16E,
            Keyword::Pi => 0xF15D,
            Keyword::Point => 0xF168,
            Keyword::Poke => 0xF1A1,
            Keyword::PokeHashTag => 0xF1A0,
            ...
            Keyword::Sgn => 0xF179,
            Keyword::Sin => 0xF17D,
            Keyword::Sorgn => 0xE684,
            Keyword::SpaceDollar => 0xF061,
            Keyword::Sqr => 0xF16B,
...
impl TryFrom<&str> for Keyword {
    ...
    fn try_from(s: &str) -> Result<Self, <Keyword as TryFrom<&str>>::Error> {
        Ok(match s {
            ...
            "PAUSE" => Keyword::Pause,
            "PEEK" => Keyword::Peek,
            "PEEK#" => Keyword::PeekHashTag,
            "PI" => Keyword::Pi,
            "POINT" => Keyword::Point,
            "POKE" => Keyword::Poke,
            "POKE#" => Keyword::PokeHashTag,
            "PRINT" => Keyword::Print,
...
impl Keyword {
    pub const fn as_str(&self) -> &'static str {
        match self {
            ...
            Keyword::Pause => "PAUSE",
            Keyword::Peek => "PEEK",
            Keyword::PeekHashTag => "PEEK#",
            Keyword::Pi => "π",
            Keyword::Point => "POINT",
            Keyword::Poke => "POKE",
            Keyword::PokeHashTag => "POKE#",
            Keyword::Print => "PRINT",
